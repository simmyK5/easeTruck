...
const App = () => {
  ...
  return (
    <AuthProvider>
      ...
      img-src 'self' data: *;
      connect-src 'self' https://api.emailjs.com https://easetruckbackend-emfbc9dje7hdargb.southafricanorth-01.azurewebsites.net wss://easetruckbackend-emfbc9dje7hdargb.southafricanorth-01.azurewebsites.net https://dev-28osh5shw2xy15j3.us.auth0.com https://www.paypal.com https://www.sandbox.paypal.com https://api.paypal.com https://api.sandbox.paypal.com https://api.sightengine.com/1.0/check.json;
