...
import { Button, Dialog, DialogActions, DialogContent, DialogTitle,FormControl,InputLabel, TextField, Select, MenuItem, Typography, Box } from '@mui/material';
import './adminInstallation.css';

const TechnicianInstallation = () => {
                    ...
                    <DialogContent>
                        <form onSubmit={handleSubmit} className="dialog-form">
                            ...
                            <TextField
                                ...
                                onChange={handleChange}
                                disabled={isEditing}
                                multiline  // Turns the TextField into a textarea
                                rows={4}
                                className="text-field"
                                data-testid="items"
                            />
...
export default TechnicianInstallation;
