...
const TechnicianInstallationProvince = ({ period,userId }) => {
    const [installationProvinceData, setInstallationProvinceData] = useState([]);

    const fetchInstallation = useCallback(async () => {
        try {
            const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/backend/dashboard/driverInstallationProvince`, {
    ...
    console.log(installationProvinceData)
...
export default TechnicianInstallationProvince;
