...
const ActiveAd = ({ userEmail, userRole }) => {
  ...
  const [currentDate, setCurrentDate] = useState(today);
    ...
    }, [userEmail, userRole, groupBy, currentDate,]);

    useEffect(() => {
        if (userEmail && userRole && groupBy && currentDate) {
            fetchAd();
        }
    }, [userEmail, userRole, groupBy, currentDate, fetchAd]);
...
const ActiveAd = ({ userEmail, userRole }) => {
                        ...
                        <Card>
                            <CardContent>
                                ...
                                {!adData ? (
                                    ...
                                    <Typography variant="body1">
                                        <strong>Number of ads:</strong> {adData.length}
                                        <strong>Total amount of ads:</strong> {adData.grossAmount}
                                    </Typography>
                                ) : (
                                    <Typography variant="body1" color="textSecondary">
                                        No ads data available.
    ...
    return (
        <Grid container spacing={3}>
            <Grid item xs={12}>
                <Typography variant="h5">Active Ad</Typography>
            </Grid>
